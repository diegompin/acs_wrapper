...
def main(datalink_acs='datalink/acs', level='zcta'):
    ...
    df = df.dropna(axis=0)
    # TODO generalize
    # filename_output = 'acs/data_output/acs_%d_%d.hdf' % (16, 5)
    filename_output = 'datalink/acs/data_output/acs_%d_%d_%s.csv' % (16, 5, level)
